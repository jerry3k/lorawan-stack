...
type RxMetadata struct {
	...
	//	*RxMetadata_GatewayIDs
	//	*RxMetadata_PacketBroker
	Source       isRxMetadata_Source `protobuf_oneof:"source"`
...
type isRxMetadata_Source interface {
	isRxMetadata_Source()
...
type RxMetadata_GatewayIDs struct {
	GatewayIDs *GatewayIdentifiers `protobuf:"bytes,1,opt,name=gateway_ids,json=gatewayIds,proto3,oneof" json:"gateway_ids,omitempty"`
}
type RxMetadata_PacketBroker struct {
	PacketBroker *PacketBrokerMetadata `protobuf:"bytes,18,opt,name=packet_broker,json=packetBroker,proto3,oneof" json:"packet_broker,omitempty"`
}

func (*RxMetadata_GatewayIDs) isRxMetadata_Source()   {}
func (*RxMetadata_PacketBroker) isRxMetadata_Source() {}

func (m *RxMetadata) GetSource() isRxMetadata_Source {
	if m != nil {
		return m.Source
	}
	return nil
...
func (m *RxMetadata) GetGatewayIDs() *GatewayIdentifiers {
	if x, ok := m.GetSource().(*RxMetadata_GatewayIDs); ok {
		return x.GatewayIDs
	}
	return nil
}
...
func (m *RxMetadata) GetPacketBroker() *PacketBrokerMetadata {
	if x, ok := m.GetSource().(*RxMetadata_PacketBroker); ok {
...
func (*RxMetadata) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*RxMetadata_GatewayIDs)(nil),
		(*RxMetadata_PacketBroker)(nil),
	}
}
...
var fileDescriptor_e1123b3e8fd87092 = []byte{
	...
	,
}
...
func (this *RxMetadata_GatewayIDs) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RxMetadata_GatewayIDs)
	if !ok {
		that2, ok := that.(RxMetadata_GatewayIDs)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *RxMetadata_PacketBroker) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RxMetadata_PacketBroker)
	if !ok {
		that2, ok := that.(RxMetadata_PacketBroker)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *RxMetadata_GatewayIDs) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RxMetadata_GatewayIDs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.GatewayIDs != nil {
		{
...
func (m *RxMetadata_PacketBroker) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RxMetadata_PacketBroker) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *RxMetadata_GatewayIDs) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RxMetadata_PacketBroker) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *RxMetadata_GatewayIDs) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RxMetadata_GatewayIDs{`,
		`GatewayIDs:` + strings.Replace(fmt.Sprintf("%v", this.GatewayIDs), "GatewayIdentifiers", "GatewayIdentifiers", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *RxMetadata_PacketBroker) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RxMetadata_PacketBroker{`,
		`PacketBroker:` + strings.Replace(fmt.Sprintf("%v", this.PacketBroker), "PacketBrokerMetadata", "PacketBrokerMetadata", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *RxMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Source = &RxMetadata_GatewayIDs{v}
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
		...
		case 18:
			...
			v := &PacketBrokerMetadata{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Source = &RxMetadata_PacketBroker{v}
			iNdEx = postIndex
		case 99:
			if wireType != 2 {
