...
func (s *routerForwarderServer) Publish(req *packetbroker.PublishUplinkMessageRequest, res packetbroker.RouterForwarderData_PublishServer) error {
	s.upCh <- &packetbroker.RoutedUplinkMessage{
		Message: req.Message,
	}
	res.Send(&packetbroker.PublishUplinkMessageResponse{
		Id:    "test",
		State: packetbroker.MessageDeliveryState_ACCEPTED,
	})
	return nil
}
...
func (s *routerHomeNetworkServer) Publish(req *packetbroker.PublishDownlinkMessageRequest, res packetbroker.RouterHomeNetworkData_PublishServer) error {
	...
	res.Send(&packetbroker.PublishDownlinkMessageResponse{
		Id:    "test",
		State: packetbroker.MessageDeliveryState_ACCEPTED,
	})
	return nil
