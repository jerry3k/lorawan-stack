...
export default class WebhookTemplateForm extends Component {
  ...
  async convertTemplateToWebhook(values) {
    ...
    const webhook = {
      ...
      uplink_message: template.uplink_message,
      join_accept: template.join_accept,
      downlink_ack: template.downlink_ack,
      downlink_nack: template.downlink_nack,
      downlink_sent: template.downlink_sent,
      downlink_failed: template.downlink_failed,
      downlink_queued: template.downlink_queued,
      location_solved: template.location_solved,
    }
